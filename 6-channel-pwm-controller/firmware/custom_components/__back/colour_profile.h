...
#include "esphome/components/ct_emulator/colour_space_converter.h"
...
namespace cms {
	...
	class ColorProfile {
        ...
        void BuildTransformFromChroma() {
            ...
            bfloat3	XYZ_W;
            ColorProfile::xyY2XYZ( bfloat3( this->m_chromaticities.W.x, this->m_chromaticities.W.y, 1.0f ), XYZ_W );
        ...
        static void ComputeWhiteBalanceXYZMatrix( const Chromaticities& _profileIn, const bfloat2& _whitePointOut, float3x3& _whiteBalanceMatrix ) {
            ColorProfile::ComputeWhiteBalanceXYZMatrix( _profileIn.R, _profileIn.G, _profileIn.B, _profileIn.W, _whitePointOut, _whiteBalanceMatrix );
        }
        ...
        static void	ComputeWhiteBalanceXYZMatrix( const bfloat2& _whitePointIn, const Chromaticities& _profileOut, float3x3& _whiteBalanceMatrix ) {
            ColorProfile::ComputeWhiteBalanceXYZMatrix( _profileOut.R, _profileOut.G, _profileOut.B, _whitePointIn, _profileOut.W, _whiteBalanceMatrix );
        }
        ...
        void white_balance_XYZ_matrix(const bfloat2& _whitePointOut, float3x3& _whiteBalanceMatrix ) {
            ColorProfile::ComputeWhiteBalanceXYZMatrix(
        ...
        void xyY2RGB( const bfloat2& _xy,const float brightness, bfloat4& _RGB ) const {
            bfloat4	XYZ;
            bfloat3	xyY;
            xyY.Set(_xy.x, _xy.y, brightness);

            ColorProfile::xyY2XYZ(xyY, (bfloat3&)XYZ);
