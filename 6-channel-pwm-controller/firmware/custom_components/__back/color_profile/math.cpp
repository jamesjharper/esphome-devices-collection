...
bfloat3 esphome::color_profile::math::operator*( const bfloat3& a, const float3x3& b ) {
	bfloat3	R;
...
bfloat3 esphome::color_profile::math::operator*( const float3x3& b, const bfloat3& a ) {
	bfloat3	R;
	R.x = a.Dot( b.r[0] );
	R.y = a.Dot( b.r[1] );
	R.z = a.Dot( b.r[2] );
...
bfloat4 esphome::color_profile::math::operator*( const bfloat4& a, const float4x4& b ) {
	bfloat4	R;
...
bfloat4 esphome::color_profile::math::operator*( const float4x4& b, const bfloat4& a ) {
	bfloat4	R;
	R.x = a.Dot( b.r[0] );
	R.y = a.Dot( b.r[1] );
	R.z = a.Dot( b.r[2] );
